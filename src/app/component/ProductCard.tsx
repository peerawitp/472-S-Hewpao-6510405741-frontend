...
function ProductCard() {
  ...
  const { data: productData, isLoading: loadingProducts, error } = 
              ...
              <div className="mt-auto">
                <div className="mt-2 text-sm">
                  <div className="flex items-center text-gray-600">
                    ...
                    <span className="ml-2">{product.deliver_from || "Not specified"}</span>
                  </div>
                  <div className="flex items-center text-gray-600 mt-1 mb-2">
                    <span className="font-medium">To:</span>
                    <span className="ml-2">{product.deliver_to || "Not specified"}</span>
                  </div>
                </div>
